...
void Instruction::SetupInstructionTable () throw ()
{
	static Instruction Instructions[] =
	{
		...
		Instruction ("ADC",
			new OptimizedBinarySyntax (Opcode (0x83, 0x02),             Syntax::FIRST_ARGUMENT,  false, Argument::NONE,         1, BinarySyntax::PARTIAL,        new Or<WordMem, WordReg>(),   new Immed<8, Number::SIGNED, false>()),
		...
		Instruction ("ADD",
			new OptimizedBinarySyntax (Opcode (0x83, 0x00),             Syntax::FIRST_ARGUMENT,  false, Argument::NONE,         1, BinarySyntax::PARTIAL,        new Or<WordMem, WordReg>(),   new Immed<8, Number::SIGNED, false>()),
		...
		Instruction ("AND",
			new OptimizedBinarySyntax (Opcode (0x83, 0x04),             Syntax::FIRST_ARGUMENT,  false, Argument::NONE,         1, BinarySyntax::PARTIAL,        new Or<WordMem, WordReg>(),   new Immed<8, Number::SIGNED, false>()),
		...
		Instruction ("BT",
			...
			new BinarySyntax          (Opcode (0x0F, 0xBA, 0x04),       Syntax::FIRST_ARGUMENT,  false, Argument::NONE,         0, BinarySyntax::PARTIAL,        new Or<SWordMem, WordReg>(),  new Immed<8, Number::UNSIGNED>())),
		...
		Instruction ("BTC",
			...
			new BinarySyntax          (Opcode (0x0F, 0xBA, 0x07),       Syntax::FIRST_ARGUMENT,  false, Argument::NONE,         0, BinarySyntax::PARTIAL,        new Or<SWordMem, WordReg>(),  new Immed<8, Number::UNSIGNED>())),
		...
		Instruction ("BTR",
			...
			new BinarySyntax          (Opcode (0x0F, 0xBA, 0x06),       Syntax::FIRST_ARGUMENT,  false, Argument::NONE,         0, BinarySyntax::PARTIAL,        new Or<SWordMem, WordReg>(),  new Immed<8, Number::UNSIGNED>())),
		...
		Instruction ("BTS",
			...
			new BinarySyntax          (Opcode (0x0F, 0xBA, 0x05),       Syntax::FIRST_ARGUMENT,  false, Argument::NONE,         0, BinarySyntax::PARTIAL,        new Or<SWordMem, WordReg>(),  new Immed<8, Number::UNSIGNED>())),
		...
		Instruction ("CLFLUSH",
			new UnarySyntax           (Opcode (0x0F, 0xAE, 0x07),       Syntax::NOTHING,                                                                         new Memory::IdFunctor<ANY, UNDEFINED, ANY>())),
		...
		Instruction ("CMP",
			new OptimizedBinarySyntax (Opcode (0x83, 0x07),             Syntax::FIRST_ARGUMENT,  false, Argument::NONE,         1, BinarySyntax::PARTIAL,        new Or<WordMem, WordReg>(),   new Immed<8, Number::SIGNED, false>()),
		...
		Instruction ("CMPPD",
			new BinarySyntax          (Opcode (0x66, 0x0F, 0xC2),       Syntax::NOTHING,         false, Argument::EQUAL,        0, BinarySyntax::EXCHANGED_REGS, new XMMReg(),                 new Or<XMMMem, XMMReg>(),           new Immed<8, Number::UNSIGNED>())),
		...
		Instruction ("CMPPS",
			new BinarySyntax          (Opcode (0x0F, 0xC2),             Syntax::NOTHING,        false, Argument::EQUAL,        0, BinarySyntax::EXCHANGED_REGS,  new XMMReg(),                 new Or<XMMReg, XMMMem>(),           new Immed<8, Number::UNSIGNED>())),
		...
		Instruction ("CMPSD",
			...
			new BinarySyntax          (Opcode (0xF2, 0x0F, 0xC2), Syntax::NOTHING,        false, Argument::NONE,         0, BinarySyntax::PRESENT,         new XMMReg(), new Or<XMMReg, Mem64f>(), new Immed<8, Number::UNSIGNED>())),
		...
		Instruction ("CMPSS",
			new BinarySyntax          (Opcode (0xF3, 0x0F, 0xC2), Syntax::NOTHING,        false, Argument::NONE,         0, BinarySyntax::EXCHANGED_REGS,  new XMMReg(), new Or<XMMReg, Memory::IdFunctor<UNDEFINED | DWORD, UNDEFINED, (UNDEFINED | FLOAT)> >(), new Immed<8, Number::UNSIGNED>())),
		...
		Instruction ("DEC",
			new UnarySyntax           (Opcode (0xFE, 0x01),       Syntax::FIRST_ARGUMENT,                                                   new Or<GPReg, GPMem>(), 1),
		...
		Instruction ("INC",
			new UnarySyntax           (Opcode (0xFE, 0x00),       Syntax::FIRST_ARGUMENT,                                                   new Or<GPReg, GPMem>(), 1),
		...
		Instruction ("INT",
			...
			new ZerarySyntax          (Opcode (0xCC),             Syntax::NOTHING,                                                          new ImmedEqual<3>)),
		...
		Instruction ("LEA",
			new BinarySyntax          (Opcode (0x8D),             Syntax::FIRST_ARGUMENT, false, Argument::NONE,         0, BinarySyntax::PRESENT, new WordReg(),    new Memory::IdFunctor<UNDEFINED | DWORD | PWORD, UNDEFINED, ANY>())),
		...
		Instruction ("LODS",
			new StringSyntax          (Opcode (0xAC),             Syntax::NOTHING,               Argument::NONE,                                   new Memory::IdFunctor <BYTE, UNDEFINED, (UNDEFINED | INTEGER)>(),  0, 0),
			new StringSyntax          (Opcode (0xAD),             Syntax::NOTHING,               Argument::NONE,                                   new Memory::IdFunctor <WORD, UNDEFINED, (UNDEFINED | INTEGER)>(), 0, 0),
			new StringSyntax          (Opcode (0xAD),             Syntax::NOTHING,               Argument::NONE,                                   new Memory::IdFunctor <DWORD, UNDEFINED, (UNDEFINED | INTEGER)>(), 0, 0)),
		...
		Instruction ("MAXSS",
			new BinarySyntax          (Opcode (0xF3, 0x0F, 0x5F), Syntax::NOTHING,        false, Argument::NONE,         0, BinarySyntax::PRESENT, new XMMReg(), new Or<XMMReg, Memory::IdFunctor<UNDEFINED | DWORD, UNDEFINED, (UNDEFINED | FLOAT)> >())),
		...
		Instruction ("MOV",
			...
			new BinarySyntax          (Opcode (0xA0),             Syntax::FIRST_ARGUMENT, true,  Argument::EQUAL,        0, BinarySyntax::ABSENT,  new Accumulator(),                new Memory::DirectMemory()),
			new BinarySyntax          (Opcode (0xC6, 0x00),       Syntax::FIRST_ARGUMENT, false, Argument::EQUAL,	       1, BinarySyntax::PARTIAL, new Or<GPReg, GPMem>(),                   new Immediate::IdFunctor()),
		...
		Instruction ("MOVAPD",
			...
			new BinarySyntax          (Opcode (0x66, 0x0F, 0x29), Syntax::NOTHING,        false, Argument::EQUAL,        0, BinarySyntax::PRESENT, new Or<XMMReg, XMMMem>(), new XMMReg())),
		...
		Instruction ("MOVAPS",
			...
			new BinarySyntax          (Opcode (0x0F, 0x29),       Syntax::NOTHING,        false, Argument::EQUAL,        0, BinarySyntax::PRESENT, new Or<XMMReg, XMMMem>(), new XMMReg())),
		...
		Instruction ("MOVDQA",
			...
			new BinarySyntax          (Opcode (0x66, 0x0F, 0x7F), Syntax::NOTHING,        false, Argument::EQUAL,        0, BinarySyntax::PRESENT, new Or<XMMReg, XMMMem>(), new XMMReg())),
		...
		Instruction ("MOVDQU",
			...
			new BinarySyntax          (Opcode (0xF3, 0x0F, 0x7F), Syntax::NOTHING,        false, Argument::EQUAL,        0, BinarySyntax::PRESENT, new Or<XMMReg, XMMMem>(), new XMMReg())),

		Instruction ("MOVDQ2Q",
			new BinarySyntax          (Opcode (0xF2, 0x0F, 0xD6), Syntax::NOTHING,        false, Argument::EQUAL,        0, BinarySyntax::PRESENT, new MMXReg(), new XMMReg())),
		...
		Instruction ("MOVNTQ",
			new BinarySyntax          (Opcode (0x0F, 0xE7),       Syntax::NOTHING,        false, Argument::EQUAL,        0, BinarySyntax::PRESENT, new XMMMem(),   new MMXReg())),
		...
		Instruction ("MOVS",
			new StringSyntax          (Opcode (0xAC),             Syntax::FIRST_ARGUMENT,        Argument::NONE,                                   new Memory::IdFunctor <BYTE, UNDEFINED, (UNDEFINED | INTEGER)>(),     new Memory::IdFunctor <BYTE, UNDEFINED, (UNDEFINED | INTEGER)>(), 0),
			new StringSyntax          (Opcode (0xAD),             Syntax::FIRST_ARGUMENT,        Argument::NONE,                                   new Memory::IdFunctor <WORD, UNDEFINED, (UNDEFINED | INTEGER)>(),    new Memory::IdFunctor <WORD, UNDEFINED, (UNDEFINED | INTEGER)>(), 0),
			new StringSyntax          (Opcode (0xAD),             Syntax::FIRST_ARGUMENT,        Argument::NONE,                                   new Memory::IdFunctor <DWORD, UNDEFINED, (UNDEFINED | INTEGER)>(),    new Memory::IdFunctor <DWORD, UNDEFINED, (UNDEFINED | INTEGER)>(), 0)),
		...
		Instruction ("MOVSS",
			new BinarySyntax          (Opcode (0xF3, 0x0F, 0x10), Syntax::NOTHING,        false, Argument::NONE,         0, BinarySyntax::PRESENT, new XMMReg(), new Or<XMMReg, Memory::IdFunctor<UNDEFINED | DWORD, UNDEFINED, (UNDEFINED | FLOAT)> >()),
			new BinarySyntax          (Opcode (0xF3, 0x0F, 0x11), Syntax::NOTHING,        false, Argument::NONE,         0, BinarySyntax::PRESENT, new Or<XMMReg, Memory::IdFunctor<UNDEFINED | DWORD, UNDEFINED, (UNDEFINED | FLOAT)> >(), new XMMReg())),

		Instruction ("MOVUPD",
			new BinarySyntax          (Opcode (0x66, 0x0F, 0x10), Syntax::NOTHING,        false, Argument::NONE,         0, BinarySyntax::PRESENT, new XMMReg(), new Or<XMMReg, Memory::IdFunctor<UNDEFINED | DWORD, UNDEFINED, (UNDEFINED | FLOAT)> >()),
			new BinarySyntax          (Opcode (0x66, 0x0F, 0x11), Syntax::NOTHING,        false, Argument::NONE,         0, BinarySyntax::PRESENT, new Or<XMMReg, Memory::IdFunctor<UNDEFINED | DWORD, UNDEFINED, (UNDEFINED | FLOAT)> >(), new XMMReg())),

		Instruction ("MOVUPS",
			new BinarySyntax          (Opcode (0x0F, 0x10),       Syntax::NOTHING,        false, Argument::NONE,         0, BinarySyntax::PRESENT, new XMMReg(), new Or<XMMReg, Memory::IdFunctor<UNDEFINED | DWORD, UNDEFINED, (UNDEFINED | FLOAT)> >()),
			new BinarySyntax          (Opcode (0x0F, 0x11),       Syntax::NOTHING,        false, Argument::NONE,         0, BinarySyntax::PRESENT, new Or<XMMReg, Memory::IdFunctor<UNDEFINED | DWORD, UNDEFINED, (UNDEFINED | FLOAT)> >(), new XMMReg())),

		Instruction ("MOVSX",
			new BinarySyntax          (Opcode (0x0F, 0xBE),       Syntax::FIRST_ARGUMENT, false, Argument::NONE,         0, BinarySyntax::PRESENT, new WordReg(),                new Or <Mem8, GPReg8>()),
			new BinarySyntax          (Opcode (0x0F, 0xBF),       Syntax::FIRST_ARGUMENT, false, Argument::NONE,         0, BinarySyntax::PRESENT, new GPReg32(), new Or <Mem16, GPReg16>())),

		Instruction ("MOVZX",
			new BinarySyntax          (Opcode (0x0F, 0xB6),       Syntax::FIRST_ARGUMENT, false, Argument::NONE,         0, BinarySyntax::PRESENT, new WordReg(),                new Or <Mem8, GPReg8>()),
			new BinarySyntax          (Opcode (0x0F, 0xB7),       Syntax::FIRST_ARGUMENT, false, Argument::NONE,         0, BinarySyntax::PRESENT, new GPReg32(), new Or <Mem16, GPReg16> ())),

		Instruction ("MUL",
			new UnarySyntax           (Opcode (0xF6, 0x04),       Syntax::FIRST_ARGUMENT,                                                          new Or<GPReg, GPMem>(), 1)),
		...
		Instruction ("MULSS",
			new BinarySyntax          (Opcode (0xF3, 0x0F, 0x59), Syntax::NOTHING,        false, Argument::NONE,         0, BinarySyntax::PRESENT, new XMMReg(), new Or<XMMReg, Memory::IdFunctor<UNDEFINED | DWORD, UNDEFINED, (UNDEFINED | FLOAT)> >())),

		Instruction ("NEG",
			new UnarySyntax           (Opcode (0xF6, 0x03),       Syntax::FIRST_ARGUMENT,                                                          new Or<GPReg, GPMem>(), 1)),

		Instruction ("NOT",
			new UnarySyntax           (Opcode (0xF6, 0x02),       Syntax::FIRST_ARGUMENT,                                                          new Or<GPReg, GPMem>(), 1)),
		...
		Instruction ("OR",
			...
			new OptimizedBinarySyntax (Opcode (0x83, 0x01),       Syntax::FIRST_ARGUMENT, false, Argument::NONE,      1, BinarySyntax::PARTIAL, new Or<WordReg, WordMem>(),             new Immed<8, Number::SIGNED, false>())),
		...
		Instruction ("OUT",
			...
			new UnarySyntax           (Opcode (0xE6),             Syntax::SECOND_ARGUMENT,                                                         new Immed<8, Number::UNSIGNED>(), new Accumulator()),
			new UnarySyntax           (Opcode (0xE7),             Syntax::SECOND_ARGUMENT,                                                         new Immed<8, Number::UNSIGNED>(), new AL())),
		...
		Instruction ("PEXTRW",
			new BinarySyntax          (Opcode (0x0F, 0xC5),       Syntax::NOTHING,        false, Argument::NONE,         0, BinarySyntax::PRESENT, new GPReg32(), new MMXReg(), new Immed<8, Number::UNSIGNED>()),
		...
		Instruction ("PINSRW",
			...
			new BinarySyntax          (Opcode (0x0F, 0xC4),       Syntax::NOTHING,        false, Argument::NONE,         0, BinarySyntax::PRESENT, new MMXReg(), new Mem16(),    new Immed<8, Number::UNSIGNED>()),
			new BinarySyntax          (Opcode (0x0F, 0xC4),       Syntax::NOTHING,        false, Argument::NONE,         0, BinarySyntax::PRESENT, new XMMReg(), new GPReg32(), new Immed<8, Number::UNSIGNED>()),
			new BinarySyntax          (Opcode (0x0F, 0xC4),       Syntax::NOTHING,        false, Argument::NONE,         0, BinarySyntax::PRESENT, new XMMReg(), new Mem16(),    new Immed<8, Number::UNSIGNED>())),
		...
		Instruction ("POP",
			new UnarySyntax           (Opcode (0x8F, 0x00),       Syntax::FIRST_ARGUMENT,                                                          new Or<GPReg, GPMem>()),
			new AdditiveUnarySyntax   (Opcode (0x58),             Syntax::FIRST_ARGUMENT,                                                          new WordReg()),
			new UnarySyntax           (Opcode (0x1F),             Syntax::NOTHING,                                                                 new DS()),
			new UnarySyntax           (Opcode (0x0F),             Syntax::NOTHING,                                                                 new CS()),
			new UnarySyntax           (Opcode (0x07),             Syntax::NOTHING,                                                                 new ES()),
			new UnarySyntax           (Opcode (0x17),             Syntax::NOTHING,                                                                 new SS()),
			new UnarySyntax           (Opcode (0x0F, 0xA1),       Syntax::NOTHING,                                                                 new FS()),
			new UnarySyntax           (Opcode (0x0F, 0xA9),       Syntax::NOTHING,                                                                 new GS())),
		...
		Instruction ("PSHUFD",
			new BinarySyntax          (Opcode (0x0F, 0x70),       Syntax::NOTHING,        false, Argument::EQUAL,        0, BinarySyntax::PRESENT, new XMMReg(), new Or<XMMReg, XMMMem>(), new Immed<8, Number::UNSIGNED>())),
		...
		Instruction ("PSLLW",
			...
			new BinarySyntax          (Opcode (0x0F, 0x71, 0x06),       Syntax::NOTHING,        false, Argument::NONE,         0, BinarySyntax::PARTIAL, new MMXReg(), new Immed<8, Number::UNSIGNED>()),
			new BinarySyntax          (Opcode (0x66, 0x0F, 0x71, 0x06), Syntax::NOTHING,  false, Argument::NONE,         0, BinarySyntax::PARTIAL, new XMMReg(), new Immed<8, Number::UNSIGNED>()),
		...
		Instruction ("PSLLD",
			...
			new BinarySyntax          (Opcode (0x0F, 0x72, 0x06),       Syntax::NOTHING,        false, Argument::NONE,         0, BinarySyntax::PARTIAL, new MMXReg(), new Immed<8, Number::UNSIGNED>()),
			new BinarySyntax          (Opcode (0x66, 0x0F, 0x72, 0x06), Syntax::NOTHING,  false, Argument::NONE,         0, BinarySyntax::PARTIAL, new XMMReg(), new Immed<8, Number::UNSIGNED>()),
		...
		Instruction ("PSLLDQ",
			new BinarySyntax          (Opcode (0x66, 0x0F, 0x73, 0x07), Syntax::NOTHING,        false, Argument::NONE,   0, BinarySyntax::PARTIAL, new XMMReg(), new Immed<8, Number::UNSIGNED>())),
		...
		Instruction ("PSLLQ",
			...
			new BinarySyntax          (Opcode (0x0F, 0x73, 0x06),       Syntax::NOTHING,        false, Argument::NONE,         0, BinarySyntax::PARTIAL, new MMXReg(), new Immed<8, Number::UNSIGNED>()),
			...
			new BinarySyntax          (Opcode (0x66, 0x0F, 0x73, 0x06), Syntax::NOTHING,  false, Argument::NONE,         0, BinarySyntax::PARTIAL, new XMMReg(), new Immed<8, Number::UNSIGNED>())),
		...
		Instruction ("PSRAW",
			...
			new BinarySyntax          (Opcode (0x0F, 0x71, 0x04),       Syntax::NOTHING,        false, Argument::NONE,         0, BinarySyntax::PARTIAL, new MMXReg(), new Immed<8, Number::UNSIGNED>()),
			...
			new BinarySyntax          (Opcode (0x66, 0x0F, 0x71, 0x04), Syntax::NOTHING,  false, Argument::NONE,         0, BinarySyntax::PARTIAL, new XMMReg(), new Immed<8, Number::UNSIGNED>())),
		...
		Instruction ("PSRAD",
			...
			new BinarySyntax          (Opcode (0x0F, 0x72, 0x04),       Syntax::NOTHING,        false, Argument::NONE,         0, BinarySyntax::PARTIAL, new MMXReg(), new Immed<8, Number::UNSIGNED>()),
			...
			new BinarySyntax          (Opcode (0x66, 0x0F, 0x72, 0x04), Syntax::NOTHING,  false, Argument::NONE,         0, BinarySyntax::PARTIAL, new XMMReg(), new Immed<8, Number::UNSIGNED>())),
		...
		Instruction ("PSRLW",
			...
			new BinarySyntax          (Opcode (0x0F, 0x71, 0x02),       Syntax::NOTHING,        false, Argument::NONE,         0, BinarySyntax::PARTIAL, new MMXReg(), new Immed<8, Number::UNSIGNED>()),
			new BinarySyntax          (Opcode (0x66, 0x0F, 0x71, 0x02), Syntax::NOTHING,  false, Argument::NONE,         0, BinarySyntax::PARTIAL, new XMMReg(), new Immed<8, Number::UNSIGNED>()),
		...
		Instruction ("PSRLD",
			...
			new BinarySyntax          (Opcode (0x0F, 0x72, 0x02),       Syntax::NOTHING,        false, Argument::NONE,         0, BinarySyntax::PARTIAL, new MMXReg(), new Immed<8, Number::UNSIGNED>()),
			new BinarySyntax          (Opcode (0x66, 0x0F, 0x72, 0x02), Syntax::NOTHING,  false, Argument::NONE,         0, BinarySyntax::PARTIAL, new XMMReg(), new Immed<8, Number::UNSIGNED>()),
		...
		Instruction ("PSRLDQ",
			new BinarySyntax          (Opcode (0x66, 0x0F, 0x73, 0x03), Syntax::NOTHING,  false, Argument::NONE,         0, BinarySyntax::PARTIAL, new XMMReg(), new Immed<8, Number::UNSIGNED>())),
		...
		Instruction ("PSRLQ",
			...
			new BinarySyntax          (Opcode (0x0F, 0x73, 0x02),       Syntax::NOTHING,        false, Argument::NONE,         0, BinarySyntax::PARTIAL, new MMXReg(), new Immed<8, Number::UNSIGNED>()),
			new BinarySyntax          (Opcode (0x66, 0x0F, 0x73, 0x02), Syntax::NOTHING,  false, Argument::NONE,         0, BinarySyntax::PARTIAL, new XMMReg(), new Immed<8, Number::UNSIGNED>()),
		...
		Instruction ("PUSH",
			new UnarySyntax           (Opcode (0xFF, 0x06),       Syntax::FIRST_ARGUMENT,                                                          new Or<GPReg, GPMem>()),
			new UnarySyntax           (Opcode (0x50),             Syntax::FIRST_ARGUMENT,                                                          new WordReg()),
			new UnarySyntax           (Opcode (0x68),             Syntax::FIRST_ARGUMENT,                                                          new DefaultImmed()),
			new UnarySyntax           (Opcode (0x1E),             Syntax::NOTHING,                                                                 new DS()),
			new UnarySyntax           (Opcode (0x0E),             Syntax::NOTHING,                                                                 new CS()),
			new UnarySyntax           (Opcode (0x06),             Syntax::NOTHING,                                                                 new ES()),
			new UnarySyntax           (Opcode (0x16),             Syntax::NOTHING,                                                                 new SS()),
			new UnarySyntax           (Opcode (0x0F, 0xA0),       Syntax::NOTHING,                                                                 new FS()),
			new UnarySyntax           (Opcode (0x0F, 0xA8),       Syntax::NOTHING,                                                                 new GS()),
		...
		Instruction ("RCL",
			new UnarySyntax           (Opcode (0xD0, 0x02),       Syntax::FIRST_ARGUMENT,                                                          new Or<GPReg, GPMem>(),               new ImmedEqual<1>(), 1),
			new BinarySyntax          (Opcode (0xD2, 0x02),       Syntax::FIRST_ARGUMENT, false, Argument::NONE,         1, BinarySyntax::PARTIAL, new Or<GPReg, GPMem>(),               new CL()),
			new BinarySyntax          (Opcode (0xC0, 0x02),       Syntax::FIRST_ARGUMENT, false, Argument::NONE,         1, BinarySyntax::PARTIAL, new Or<GPReg, GPMem>(),               new Immed<8, Number::UNSIGNED>())),

		Instruction ("RCR",
			new UnarySyntax           (Opcode (0xD0, 0x03),       Syntax::FIRST_ARGUMENT,                                                          new Or<GPReg, GPMem>(),               new ImmedEqual<1>(), 1),
			new BinarySyntax          (Opcode (0xD2, 0x03),       Syntax::FIRST_ARGUMENT, false, Argument::NONE,         1, BinarySyntax::PARTIAL, new Or<GPReg, GPMem>(),               new CL()),
			new BinarySyntax          (Opcode (0xC0, 0x03),       Syntax::FIRST_ARGUMENT, false, Argument::NONE,         1, BinarySyntax::PARTIAL, new Or<GPReg, GPMem>(),               new Immed<8, Number::UNSIGNED>())),

		Instruction ("ROL",
			new UnarySyntax           (Opcode (0xD0, 0x00),       Syntax::FIRST_ARGUMENT,                                                          new Or<GPReg, GPMem>(),               new ImmedEqual<1>(), 1),
			new BinarySyntax          (Opcode (0xD2, 0x00),       Syntax::FIRST_ARGUMENT, false, Argument::NONE,         1, BinarySyntax::PARTIAL, new Or<GPReg, GPMem>(),               new CL()),
			new BinarySyntax          (Opcode (0xC0, 0x00),       Syntax::FIRST_ARGUMENT, false, Argument::NONE,         1, BinarySyntax::PARTIAL, new Or<GPReg, GPMem>(),               new Immed<8, Number::UNSIGNED>())),

		Instruction ("ROR",
			new UnarySyntax           (Opcode (0xD0, 0x01),       Syntax::FIRST_ARGUMENT,                                                          new Or<GPReg, GPMem>(),               new ImmedEqual<1>(), 1),
			new BinarySyntax          (Opcode (0xD2, 0x01),       Syntax::FIRST_ARGUMENT, false, Argument::NONE,         1, BinarySyntax::PARTIAL, new Or<GPReg, GPMem>(),               new CL()),
			new BinarySyntax          (Opcode (0xC0, 0x01),       Syntax::FIRST_ARGUMENT, false, Argument::NONE,         1, BinarySyntax::PARTIAL, new Or<GPReg, GPMem>(),               new Immed<8, Number::UNSIGNED>())),
		...
		Instruction ("RCPSS",
			new BinarySyntax          (Opcode (0xF3, 0x0F, 0x53), Syntax::NOTHING,        false, Argument::EQUAL,        0, BinarySyntax::PRESENT, new XMMReg(), new Or<XMMReg, Memory::IdFunctor<UNDEFINED | DWORD, UNDEFINED, (UNDEFINED | FLOAT)> >())),
		...
		Instruction ("RSQRTSS",
			new BinarySyntax          (Opcode (0xF3, 0x0F, 0x52), Syntax::NOTHING,        false, Argument::EQUAL,        0, BinarySyntax::PRESENT, new XMMReg(), new Or<XMMReg, Memory::IdFunctor<UNDEFINED | DWORD, UNDEFINED, (UNDEFINED | FLOAT)> >())),
		...
		Instruction ("SAL",
			new UnarySyntax           (Opcode (0xD0, 0x04),       Syntax::FIRST_ARGUMENT,                                                          new Or<GPReg, GPMem>(),               new ImmedEqual<1>(), 1),
			new BinarySyntax          (Opcode (0xD2, 0x04),       Syntax::FIRST_ARGUMENT, false, Argument::NONE,         1, BinarySyntax::PARTIAL, new Or<GPReg, GPMem>(),               new CL()),
			new BinarySyntax          (Opcode (0xC0, 0x04),       Syntax::FIRST_ARGUMENT, false, Argument::NONE,         1, BinarySyntax::PARTIAL, new Or<GPReg, GPMem>(),               new Immed<8, Number::UNSIGNED>())),

		Instruction ("SAR",
			new UnarySyntax           (Opcode (0xD0, 0x07),       Syntax::FIRST_ARGUMENT,                                                          new Or<GPReg, GPMem>(),               new ImmedEqual<1>(), 1),
			new BinarySyntax          (Opcode (0xD2, 0x07),       Syntax::FIRST_ARGUMENT, false, Argument::NONE,         1, BinarySyntax::PARTIAL, new Or<GPReg, GPMem>(),               new CL()),
			new BinarySyntax          (Opcode (0xC0, 0x07),       Syntax::FIRST_ARGUMENT, false, Argument::NONE,         1, BinarySyntax::PARTIAL, new Or<GPReg, GPMem>(),               new Immed<8, Number::UNSIGNED>())),
		...
		Instruction ("SBB",
			...
			new OptimizedBinarySyntax (Opcode (0x83, 0x03),       Syntax::FIRST_ARGUMENT, false, Argument::NONE,      1, BinarySyntax::PARTIAL, new Or<WordReg, WordMem>(),             new Immed<8, Number::SIGNED, false>())),

		Instruction ("SCAS",
			new StringSyntax          (Opcode (0xAE),             Syntax::NOTHING,               Argument::NONE,                                   new Memory::IdFunctor <BYTE, UNDEFINED, (UNDEFINED | INTEGER)>(),  0, 2),
			new StringSyntax          (Opcode (0xAF),             Syntax::NOTHING,               Argument::NONE,                                   new Memory::IdFunctor <WORD, UNDEFINED, (UNDEFINED | INTEGER)>(), 0, 2),
			new StringSyntax          (Opcode (0xAF),             Syntax::NOTHING,               Argument::NONE,                                   new Memory::IdFunctor <DWORD, UNDEFINED, (UNDEFINED | INTEGER)>(), 0, 2)),
		...
		Instruction ("SGDT",
			new UnarySyntax           (Opcode (0x0F, 0x01, 0x00), Syntax::FIRST_ARGUMENT,                                                          new SMem48())),
		...
		Instruction ("SHLD",
			new BinarySyntax          (Opcode (0x0F, 0xA4),       Syntax::FIRST_ARGUMENT, false, Argument::EQUAL,        0, BinarySyntax::PRESENT, new Or<WordReg, WordMem>(),             new WordReg(),                     new CL()),
			new BinarySyntax          (Opcode (0x0F, 0xA5),       Syntax::FIRST_ARGUMENT, false, Argument::EQUAL,        0, BinarySyntax::PRESENT, new Or<WordReg, WordMem>(),             new WordReg(),                     new Immed<8, Number::UNSIGNED>())),

		Instruction ("SHR",
			new UnarySyntax           (Opcode (0xD0, 0x05),       Syntax::FIRST_ARGUMENT,                                                          new Or<GPReg, GPMem>(),               new ImmedEqual<1>(), 1),
			new BinarySyntax          (Opcode (0xD2, 0x05),       Syntax::FIRST_ARGUMENT, false, Argument::NONE,         1, BinarySyntax::PARTIAL, new Or<GPReg, GPMem>(),               new CL()),
			new BinarySyntax          (Opcode (0xC0, 0x05),       Syntax::FIRST_ARGUMENT, false, Argument::NONE,         1, BinarySyntax::PARTIAL, new Or<GPReg, GPMem>(),               new Immed<8, Number::UNSIGNED>())),

		Instruction ("SHRD",
			new BinarySyntax          (Opcode (0x0F, 0xAC),       Syntax::FIRST_ARGUMENT, false, Argument::EQUAL,        0, BinarySyntax::PRESENT, new Or<WordReg, WordMem>(),             new WordReg(),                     new CL()),
			new BinarySyntax          (Opcode (0x0F, 0xAD),       Syntax::FIRST_ARGUMENT, false, Argument::EQUAL,        0, BinarySyntax::PRESENT, new Or<WordReg, WordMem>(),             new WordReg(),                     new Immed<8, Number::UNSIGNED>())),

		Instruction ("SHUFPD",
			new BinarySyntax          (Opcode (0x66, 0x0F, 0xC6), Syntax::NOTHING,        false, Argument::EQUAL,        0, BinarySyntax::PRESENT, new XMMReg(), new Or<XMMReg, XMMMem>(), new Immed<8, Number::UNSIGNED>())),
		...
		Instruction ("SIDT",
			new UnarySyntax           (Opcode (0x0F, 0x01, 0x01), Syntax::FIRST_ARGUMENT,                                                          new SMem48())),
		...
		Instruction ("STOS",
			...
			new StringSyntax          (Opcode (0xAB),             Syntax::NOTHING,               Argument::NONE,                                   new Memory::IdFunctor <WORD, UNDEFINED, (UNDEFINED | INTEGER)>(), 0, 2),
			new StringSyntax          (Opcode (0xAB),             Syntax::NOTHING,               Argument::NONE,                                   new Memory::IdFunctor <DWORD, UNDEFINED, (UNDEFINED | INTEGER)>(), 0, 2)),
		...
		Instruction ("SUB",
			...
			new OptimizedBinarySyntax (Opcode (0x83, 0x05),       Syntax::FIRST_ARGUMENT, false, Argument::NONE,      1, BinarySyntax::PARTIAL, new Or<WordReg, WordMem>(),             new Immed<8, Number::SIGNED, false>())),
		...
		Instruction ("TEST",
			new BinarySyntax          (Opcode (0xF6, 0x00),       Syntax::FIRST_ARGUMENT, false, Argument::EQUAL,	       1, BinarySyntax::PARTIAL, new Or<GPReg, GPMem>(),    new Immediate::IdFunctor()),
		...
		Instruction ("UCOMISD",
			new BinarySyntax          (Opcode (0x66, 0x0F, 0x2E), Syntax::NOTHING,        false, Argument::EQUAL,        0, BinarySyntax::PRESENT, new XMMReg(), new Or<XMMReg, Mem64f>())),

		Instruction ("UCOMISS",
			new BinarySyntax          (Opcode (0x0F, 0x2E),       Syntax::NOTHING,        false, Argument::EQUAL,        0, BinarySyntax::PRESENT, new XMMReg(), new Or<XMMReg, Memory::IdFunctor<UNDEFINED | DWORD, UNDEFINED, (UNDEFINED | FLOAT)> >())),
		...
		Instruction ("VERR",
			new UnarySyntax           (Opcode (0x0F, 0x00, 0x04), Syntax::NOTHING,                                                                 new Or<WordReg, WordMem>())),

		Instruction ("VERW",
			new UnarySyntax           (Opcode (0x0F, 0x00, 0x05), Syntax::NOTHING,                                                                 new Or<WordReg, WordMem>())),

		Instruction ("WAIT",
			new ZerarySyntax          (Opcode (0x9),              Syntax::NOTHING)),
		...
		Instruction ("XADD",
			new BinarySyntax          (Opcode (0x0F, 0xC0),       Syntax::FIRST_ARGUMENT, false, Argument::EQUAL,        1, BinarySyntax::PRESENT, new Or<WordReg, WordMem>(), new WordReg())),
		...
		Instruction ("XLAT",
			new StringSyntax          (Opcode (0xD7),             Syntax::NOTHING,               Argument::NONE,                                                 new Memory::IdFunctor <BYTE, UNDEFINED, (UNDEFINED | INTEGER)>(),     0, 0)),
		...
		Instruction ("XOR",
			...
			new OptimizedBinarySyntax (Opcode (0x83, 0x06),    Syntax::FIRST_ARGUMENT, false, Argument::NONE,         1, BinarySyntax::PARTIAL, new Or<WordReg, WordMem>(),             new Immed<8, Number::SIGNED, false>())),
